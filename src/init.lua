...
-- addon loads - check for saved var
-- player enters world - calculate and show rested, update current xp/rxp
-- some event (gains experience?)- update curent xp/rxp
-- player logs out - update logged out time
